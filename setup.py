...
if __name__ == '__main__':
    ...
    setup(
        name='iNAS',
        version=get_version(),
        description='Open Source Neural Architecture Search Toolbox for Device-aware Salient Object Detection',
        long_description=readme(),
        long_description_content_type='text/markdown',
        author='Yuchao Gu',
        author_email='ycgu@mail.nankai.edu.cn',
        keywords='computer vision, salient object detection, neural architecture search',
