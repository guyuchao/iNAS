...
def update_sha(paths):
    ...
    for idx, path in enumerate(paths):
        ...
        if 'params' not in net and 'params_ema' not in net and 'state_dict' not in net:
...
if __name__ == '__main__':
    paths = ['D:\\Codes\\iNAS_DEV-main\\experiments\\pretrained_models\\search_space\\checkpoint.pth']
