...
from iNAS.models import lr_scheduler as lr_scheduler
from iNAS.utils import get_root_logger
from iNAS.utils.dist_util import master_only
...
class BaseModel():
    ...
    def setup_schedulers(self):
        ...
        if scheduler_type in ['PolynomialLRDecay']:
            for optimizer in self.optimizers:
                self.schedulers.append(lr_scheduler.PolynomialLRDecay(optimizer, **train_opt['scheduler']))
        else:
